package com.test.my_attendance.ui.maps
...
import com.test.my_attendance.databinding.FragmentMapsBinding
...
import com.test.my_attendance.util.Permissions.hasBackgroundLocationPermission
import com.test.my_attendance.util.Permissions.requestsBackgroundLocationPermission
    ...
    private fun drawCircle(location: LatLng, radius: Float) {
        circle = map.addCircle(
            CircleOptions().center(location).radius(radius.toDouble())
                .strokeColor(ContextCompat.getColor(requireContext(), R.color.blue_primary))
